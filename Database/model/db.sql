...
CREATE TABLE IF NOT EXISTS `help_ukr`.`languages` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `lang_UNIQUE` (`name` ASC),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `help_ukr`.`users` (
  ...
  `lang_id` TINYINT(4) UNSIGNED NULL,
...
-- -----------------------------------------------------
-- Table `help_ukr`.`posts`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `help_ukr`.`posts` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `text` VARCHAR(4095) NOT NULL,
  `category_id` INT UNSIGNED NOT NULL,
  `lang_id` TINYINT(4) UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `category_id_UNIQUE` (`category_id` ASC, `lang_id` ASC),
  INDEX `lang_id_lang_idx` (`lang_id` ASC),
  CONSTRAINT `posts_cat_id_cat`
    FOREIGN KEY (`category_id`)
    REFERENCES `help_ukr`.`categories` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `posts_lang_id_lang`
    FOREIGN KEY (`lang_id`)
    REFERENCES `help_ukr`.`languages` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- Table `help_ukr`.`ads`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `help_ukr`.`ads` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  INDEX `user_id_user_idx` (`user_id` ASC),
  CONSTRAINT `user_id_user`
    FOREIGN KEY (`user_id`)
    REFERENCES `help_ukr`.`users` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
START TRANSACTION;
USE `help_ukr`;
INSERT INTO `help_ukr`.`languages` (`id`, `name`, `value`) VALUES (1, 'eng', '🇬🇧 English');
INSERT INTO `help_ukr`.`languages` (`id`, `name`, `value`) VALUES (2, 'ukr', '🇺🇦 Українська');
INSERT INTO `help_ukr`.`languages` (`id`, `name`, `value`) VALUES (3, 'rus', '🇷🇺 Русский');
